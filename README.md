...
Circuit_Diagram/             → Hardware schematic  
Flowchart_Block_Diagram/     → Flowchart and block diagram  
...
- Arduino processes sensor data and makes navigation decisions

- Motor driver controls vehicle movement based on obstacle detection logic

- ESP32-CAM streams real-time video over Wi-Fi
